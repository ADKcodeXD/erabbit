    ...
    <div class="container">
      ...
      <div class="pay-result">
        <span
          ...
          class="iconfont icon-success green"
        ></span>
        <span v-else class="iconfont icon-wrong red"></span>
        <p class="tit">
        ...
        <div class="btn">
          <XtxButton type="primary" style="margin-right: 20px" @click="$router.push(`/member/order/${order.id}`)"
            >查看订单</XtxButton
          >
