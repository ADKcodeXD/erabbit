<template>
  <div class="account-box">
    ...
    <!-- 表单组件主体 -->
    <Form class="form" ref="formCom" :validation-schema="schema" v-slot="{errors}">
      <!-- 密码登录 -->
      ...
      <template v-else>
        ...
        <div class="form-item">
          <div class="input">
            ...
            <span @click="send" class="code">{{time==0?'发送验证码':`${time}秒后可发送`}}</span>
          </div>
      ...
      <div class="form-item">
        <div class="agree">
          <Field as="XtxCheckbox" name="isAgree" :class="{error:errors.isAgree}" v-model="form.isAgree" />
          <span>我已同意</span>
...
<script>
  ...
  import {userAccountLogin,userMessageLogin, userMobileLogin} from '@/api/user';
